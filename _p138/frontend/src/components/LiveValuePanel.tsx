...
function Tile({
  ...
  return (
    <div className="border border-border rounded-md bg-card p-2.5 flex flex-col gap-1.5">
      {/* Row 1: color swatch + name + comm state */}
      <div className="flex items-center gap-2">
        <span
          ...
          aria-hidden
        />
        <span className="font-semibold text-xs truncate flex-1">{tag.name}</span>
        <span
      ...
      {/* Last update absolute timestamp - small, only shown on hover via title */}
      <div
