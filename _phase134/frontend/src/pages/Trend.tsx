...
// Mirror of TimeRangePicker's PRESETS — used to detect whether the
// current historical range matches a named preset (in which case we save
// it as a relative window) or is a fully custom range (saved as absolute
// timestamps). Keeping this in sync with TimeRangePicker is a small
// maintenance cost worth paying so save-and-reload behaves intuitively.
const LIVE_WINDOW_OPTIONS_HIST: { minutes: number; label: string }[] = [
  { minutes: 15,    label: "Last 15 min" },
  { minutes: 60,    label: "Last 1 h" },
  { minutes: 360,   label: "Last 6 h" },
  { minutes: 1440,  label: "Last 24 h" },
  { minutes: 10080, label: "Last 7 d" },
  { minutes: 43200, label: "Last 30 d" },
];
