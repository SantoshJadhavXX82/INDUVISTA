...
const TrendChart = forwardRef<TrendChartHandle, TrendChartProps>(
  function TrendChart({ history, height = 420 }, ref) {
    ...
    useEffect(() => {
      if (document.getElementById("trend-marker-legend-style")) return;
      const style = document.createElement("style");
      style.id = "trend-marker-legend-style";
      style.textContent = `.u-legend .u-marker-row { display: none !important; }`;
